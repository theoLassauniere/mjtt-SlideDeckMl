...
- [src/slide-deck-ml.langium](src/slide-deck-ml.langium) -  The grammar definition of your language
- [src/slide-deck-ml-module.ts](src/slide-deck-ml-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/slide-deck-ml-validator.ts](src/slide-deck-ml-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/slide-deck-ml.monarch.ts](src/syntaxes/slide-deck-ml.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/slide-deck-ml.tmLanguage.json](syntaxes/slide-deck-ml.tmLanguage.json) - Textmate based syntax highlighting instructions.
