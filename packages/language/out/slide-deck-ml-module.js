 ...
 */
export const SlideDeckMlModule = {
    validation: {
 ...
 */
export function createSlideDeckMlServices(context) {
    const shared = inject(createDefaultSharedModule(context), SlideDeckMlGeneratedSharedModule);
    const SlideDeckMl = inject(createDefaultModule({ shared }), SlideDeckMlGeneratedModule, SlideDeckMlModule);
...
//# sourceMappingURL=slide-deck-ml-module.js.map